"""
Django settings for selfincome project.
...
EMAIL_HOST_PASSWORD = 'frmwbjnihbtvyxso'

DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
SERVER_EMAIL = EMAIL_HOST_USER
EMAIL_ADMIN = EMAIL_HOST_USER
EMAIL_ADMINS = ('help-selfincome@yandex.ru', 'kliutko.fr@ya.ru',)  # Email Admin to Feedback
...
SECRET_KEY = 'django-insecure-_8+!g8lcpjj7luimx11^w46vxj9=3)q72d2@*@l93jxk-kam-*'
...
WSGI_APPLICATION = 'selfincome.wsgi.application'
